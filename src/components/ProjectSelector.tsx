...
const ProjectSelector = () => {
  const { currentProject, setCurrentProject, userProjects, loadUserProjects } =
    useProject();
      ...
      const { error } = await supabase.from("project_invitations").insert([
        {
          ...
          ).toISOString(), // Assuming the invitation expires in 7 days
          invited_user: inviteEmail, // Use the fetched user email
          inviter_user: user?.id, // Assuming the inviter is the current authenticated user
  ...
  return (
    <>
      <div className="relative">
        ...
        <div
          className={`absolute z-50 w-21 bg-white rounded-lg shadow-black shadow-2xl border border-indigo-200 transition-all duration-200 ease-in-out ${
            isSlideUpOpen
          ...
          style={{
            bottom: buttonRef.current
              ? buttonRef.current.offsetHeight + 10
              : "3rem",
            left: 0,
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-1">
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${getProjectStatusColor(
                            project.status
                          )}`}
                        >
                          {project.status}
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {/* Create an error box that tells that something is wrong */}
                </div>
              </div>
